...
def main():
    ...
    train_loader, val_loader, classes, mean, std = make_loaders(
        ...
        sample_limit_for_stats=None,           # e.g., 20000 to speed up on full 1k
